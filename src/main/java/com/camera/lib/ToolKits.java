...
import com.camera.common.ErrorCode;
//import com.camera.module.LoginModule;
import com.camera.lib.NetSDKLib.LLong;
...
public class ToolKits {
     ...
     * 传入图片路径, 打开图片, 并在面板显示
     */
    public static File openPictureFile(String picPath) {
        /*
         * 读取本地图片, 并在面板上显示
         */
        BufferedImage bufferedImage = null;
...
//			((Memory) pointer).clear(b.length+1);
